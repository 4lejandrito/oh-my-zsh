...
@curl -L https://github.com/4lejandrito/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://github.com/4lejandrito/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/4lejandrito/oh-my-zsh.git ~/.oh-my-zsh@
...
* "View our growing list of contributors":https://github.com/4lejandrito/oh-my-zsh/contributors
